...
export function Installing() {
  ...
  let valArray = ["npm install mymx","pnpm add mymx","yarn add mymx","bun add mymx"]
  ...
  return (
    <div className="mt-[10rem] w-full flex items-center justify-center">
        ...
        <div className="w-[35%] flex flex-col space-y-2 items-center justify-center">

            <div className="w-full flex items-center justify-center space-x-5">
                <button onClick={()=>makeValue(0)} className={colorValue === 0 ? "text-bold p-2 rounded-lg bg-blue-900":"bg-black p-2 rounded-lg text-bold"}>npm</button>
                <button onClick={()=>makeValue(1)} className={colorValue === 1 ? "text-bold p-2 rounded-lg bg-blue-900":"bg-black p-2 rounded-lg text-bold"}>pnpm</button>
                <button onClick={()=>makeValue(2)} className={colorValue === 2 ? "text-bold p-2 rounded-lg bg-blue-900":"bg-black p-2 rounded-lg text-bold"}>yarn</button>
                <button onClick={()=>makeValue(3)} className={colorValue === 3 ? "text-bold p-2 rounded-lg bg-blue-900":"bg-black p-2 rounded-lg text-bold"}>bun</button>
            </div>

            <div className="w-[70%] h-[50px] mt-[30px] border-2 bg-blue-900 flex items-center justify-center space-x-10">
                <div>
                    <h1>$ {copyValue}</h1>
                </div>
